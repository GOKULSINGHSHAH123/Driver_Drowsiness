...
# Load YOLOv5 model
model = torch.hub.load('ultralytics/yolov5', 'custom', path=r"C:\Users\gokul\PycharmProjects\pythonProject1\models\last.pt", force_reload=True)

# Initialize the mixer
mixer.init()
sound = mixer.Sound(r"C:\Users\gokul\objectDetection\drowsinessProject\alarm (1).wav")
